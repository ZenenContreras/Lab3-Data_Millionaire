...
class Ganaste:
    def __init__(self, master, puntaje, regresar_menu_principal, salir_aplicacion, mensaje):
        ...
        self.label_resultado = tk.Label(master, text=f"Obtuviste el puntaje máximo: {puntaje}", font=resultado_fuente, bg='light blue')
        ...
        self.imagen = Image.open('imagenes/goodjobr.jpg')  # Asegúrate de que la ruta a la imagen sea correcta
